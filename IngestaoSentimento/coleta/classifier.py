...
def classify_texts_individual(texts, candidate_nome, candidate_contexto=""):
    ...
    prompt_prefix = (
        ...
        f"NEGATIVO: crítica direta, associação a escândalo ou incompetência, queda nas pesquisas, "
        f"piada ou meme que ridiculariza, ataque de adversários sem resposta.\n"
